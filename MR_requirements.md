...
Формат:  
`<тип>/<название-команды>-<описание-задачи>`

**Типы:**
- `feature` — новая функциональность (например, новая функция)
...
**Примеры:**
- `feat/alpha-strcat-implementation`
- `fix/beta-strlen-off-by-one`
- `refactor/gamma-strcpy-optimize`
- `docs/delta-update-readme`
- `test/gamma-add-strcmp-tests`
...
**Примеры:**
- `[feature] Реализация функции strcat`

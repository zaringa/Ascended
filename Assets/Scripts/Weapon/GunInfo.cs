...
public class GunInfo : Item, IRenderable
{
	public enum WeaponType { Melee, Firearm } // Перечисление для типизации оружия
	...
	public GameObject Prefab { get => weaponModelPrefab; set => weaponModelPrefab = value; }
